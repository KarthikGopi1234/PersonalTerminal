...
value-for-effort inside each group. Nothing here is committed; it is a menu to pick from.
Effort: **S** = an evening, **M** = a weekend, **L** = a multi-week feature.
...
1. **Reminders (1.1)** – the biggest missing habit-app fundamental.
2. **Command line on Today (6.1)** – the feature that makes this app *this* app.
3. **Collection stats + service log (3.1 + 3.2)** – cheap, and they make the watch half feel complete.
